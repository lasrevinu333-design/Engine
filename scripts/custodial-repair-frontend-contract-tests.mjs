...
assert.equal(manifest.release_id, 'release-2026.07.18.custodial-v3.10');
assert.equal(manifest.schema_fingerprint, '3021092f7438c651ece9920418ca4110cf44dfa28edb621f0cc43cbb8def085e');
