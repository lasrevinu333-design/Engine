...
assert(source.includes("RINGTONE_HOSTED_FILE: 'memphis-alert-tone.wav?v=release-2026.07.24.custodial-v3.14'"), 'Reminder popups must ship the selected hosted fleet ringtone asset');
