...
assert(source.includes("RINGTONE_HOSTED_FILE: 'memphis-alert-tone.wav?v=release-2026.07.17.custodial-repair.1'"), 'Reminder popups must ship the selected hosted fleet ringtone asset');
