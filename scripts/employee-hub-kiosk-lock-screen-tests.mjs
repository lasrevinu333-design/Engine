...
contains('front lock maps Michael KIOSK_03 correctly', "KIOSK_03:'Michael McWright'");
contains('front lock maps Karen KIOSK_08 correctly', "KIOSK_08:'Karen Robinson'");
