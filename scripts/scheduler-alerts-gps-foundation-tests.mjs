...
assert.match(read('employee-schedule.html'), /release-2026\.07\.24\.custodial-v3\.16/);
assert.match(read('messages.html'), /release-2026\.07\.24\.custodial-v3\.16/);
assert.match(sharedSync, /release-2026\.07\.24\.custodial-v3\.16/);
