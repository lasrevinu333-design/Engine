...
assert.match(source, /release-2026\.07\.15\.device-credentials\.1/);
...
for (const page of protectedPages) {
  assert.match(read(page), /memphis-device-identity\.js\?v=release-2026\.07\.15\.device-credentials\.1/);
}
