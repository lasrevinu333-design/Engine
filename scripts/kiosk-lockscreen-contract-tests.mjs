...
function checkEmployeeHub(source) {
  ...
  assert(/return isFullyKioskRuntime\(\)&&normalized\.startsWith\('KIOSK_'\);/.test(source), 'Employee hub automatic lockscreen gating must still require Fully Kiosk runtime');
}
