...
const managerPlugins = ['@capacitor-firebase/messaging', '@capacitor/app', '@capacitor/network', '@capacitor/status-bar'];
...
const config: CapacitorConfig = {
  ...
  // Native bridge responses can contain push tokens and bounded operation
  // results, so release binaries must only log them in debug builds.
