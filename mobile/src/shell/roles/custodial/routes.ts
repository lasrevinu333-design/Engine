...
export const custodialDefinition: EditionDefinition = {
  ...
  routes: [
    ...
    { id: 'custodial.feedback', path: '/feedback', label: 'Feedback', shortLabel: 'Feedback', description: 'Open employee feedback.', legacyTarget: './system-feedback.html?hub=employee', navigation: false },
