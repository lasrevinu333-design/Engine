...
public final class VaultAndroidRuntimeTest {
    ...
    private static final String LEGACY_CREDENTIAL_ALIAS = "capacitor-storage_memphis_zoo_manager_device_credential";
    private static final String LEGACY_SEAL_ALIAS = "capacitor-storage_memphis_zoo_manager_installation_seal";
    private static final String LEGACY_RECORD_ALIAS = "capacitor-storage_memphis_zoo_manager_installation_record_v1";
    ...
    public void actualSharedPreferencesFailBeforeStageCommitCompensatesWithoutOrphan() throws Exception {
        ...
        try {
            ...
            assertEquals("manager_native_vault_commit_failed", error.code);
        }
    ...
    public void adversarialDirectBridgeCannotInvokeInternalTransitionSteps() throws Exception {
        ...
        try (ActivityScenario<BridgeSmokeActivity> scenario = ActivityScenario.launch(BridgeSmokeActivity.class)) {
            ...
            JSONObject state = result.getJSONObject("state");
            assertEquals("CREDENTIAL_STAGED", state.getString("state"));
