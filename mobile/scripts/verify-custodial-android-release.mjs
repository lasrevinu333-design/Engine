...
export function normalizeCustodialSourceRef(value) {
  ...
  const recoveryBranch = 'release/custodial-build27-recovery-v30-implementation-20260815';
  if (sourceRef === recoveryBranch || sourceRef === `refs/heads/${recoveryBranch}`) {
    return `refs/heads/${recoveryBranch}`;
  }
  throw new Error('Custodial release source ref must be protected main or the exact Build 27 recovery branch');
}
