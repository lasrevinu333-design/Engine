...
export const CUSTODIAL_FORWARD_RECOVERY_BRANCH =
  'release/custodial-build29-recovery-v42-implementation-20260825';
export const CUSTODIAL_FORWARD_RECOVERY_REF = `refs/heads/${CUSTODIAL_FORWARD_RECOVERY_BRANCH}`;
export const CUSTODIAL_FORWARD_RECOVERY_VERSION_CODE = 42;
export {
  CUSTODIAL_ANDROID_MANIFEST_SECURITY_VERIFIER_VERSION,
  CUSTODIAL_DEX_SEMANTIC_VERIFIER_VERSION,
  CUSTODIAL_NATIVE_VAULT_PLUGIN_METHODS,
...
function loadCustodialRollbackBaseline(release) {
  ...
  const expectedDrillCandidateVersion = candidateDrillComplete
    ? release.maximum_candidate_version_code_for_staged_recovery
