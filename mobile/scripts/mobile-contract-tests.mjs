...
for (const module of ['Dashboard','Messenger','Scheduler','Events','Guest Issues','Moxie','Feedback','Gemini Console','Manager Access','Device Security']) assert.ok(managerHtml.includes(module), `manager app missing ${module}`);
