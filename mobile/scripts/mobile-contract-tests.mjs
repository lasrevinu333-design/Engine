...
assert.match(nativeLinks, /NfcAdapter\.EXTRA_TAG/);
assert.match(nativeLinks, /NfcAdapter\.EXTRA_NDEF_MESSAGES/);
assert.match(nativeLinks, /data\.equals\(record\.toUri\(\)\)/);
assert.match(nativeLinks, /intent\.removeExtra\(VERIFIED_NFC_SCAN\)/);
